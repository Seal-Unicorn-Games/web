  ...
  */ !function(t, e) {
        ...
        _maybeSanitize(t) {
            return this._config.sanitize ? function(t, e, i) {
                ...
                for (const t1 of s){
                    ...
                    for (const e1 of n1)Ki(e1, s1) || t1.removeAttribute(e1.nodeName);
                }
    ...
    class cn extends z {
        ...
        show() {
            ...
            if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(i), P.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(i), i.classList.add(tn), "ontouchstart" in document.documentElement) for (const t1 of [].concat(...document.body.children))P.on(t1, "mouseover", h);
            this._queueCallback(()=>{
        ...
        _setListeners() {
            ...
            for (const e of t)if ("click" === e) P.on(this._element, this.constructor.eventName("click"), this._config.selector, (t)=>{
                ...
                const t1 = e === sn ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"), i = e === sn ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout");
        ...
        _getConfig(t) {
            ...
            for (const t1 of Object.keys(e))Ji.has(t1) && delete e[t1];
            return t = {
                ...e,
                ..."object" == typeof t && t ? t : {}
    ...
    class bn extends z {
        ...
        _activateParents(t) {
            ...
            else for (const e of Q.parents(t, ".nav, .list-group"))for (const t1 of Q.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item"))t1.classList.add(pn);
        }
        _clearActiveClass(t) {
            t.classList.remove(pn);
            const e = Q.find("[href].active", t);
            for (const t1 of e)t1.classList.remove(pn);
        }
        static jQueryInterface(t) {
            return this.each(function() {
