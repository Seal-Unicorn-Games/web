...
var _bs5Lightbox = require("bs5-lightbox");
var _bootstrap = require("bootstrap");
var _gamesJson = require("./content/games.json");
var _gamesJsonDefault = parcelHelpers.interopDefault(_gamesJson);
var _png = require("url:./content/*/*.png");
var _pngDefault = parcelHelpers.interopDefault(_png);
var _png1 = require("url:./content/*/screenshots/*.png");
var _pngDefault1 = parcelHelpers.interopDefault(_png1);
var _jpg = require("url:./content/*/screenshots/*.jpg");
var _jpgDefault = parcelHelpers.interopDefault(_jpg);
var _png2 = require("url:./content/*.png");
var _pngDefault2 = parcelHelpers.interopDefault(_png2);
var _bs5LightboxDefault = parcelHelpers.interopDefault(_bs5Lightbox);
const gameScreenshots = Object.assign({}, (0, _pngDefault1.default), (0, _jpgDefault.default));
...
function goToPage(event) {
    ...
    if (tag.href && tag.className != "screenshots") // It's a same-origin navigation: a link within the site.
    {
        if (tag.origin == document.location.origin) {
            let newPath = tag.pathname;
            let gamesPathname = Object.keys((0, _gamesJsonDefault.default)).map((name)=>`/games/${name}`);
            let pathes = [
                ...gamesPathname,
                "/",
                "/homepage",
...
window.onpopstate = function(event) {
    if (event.state) app(window.location.pathname);
};
function app(path) {
    // https://sealunicorn.com/
    // By default, load the homepage
    if (path === undefined) loadHomepage();
    else {
        if (path.startsWith("/games/")) loadGame(path.slice(7));
        switch(path){
            case "/homepage":
            case "/":
                loadHomepage();
...
function loadHomepage() {
    ...
    document.querySelector("#homepage").innerHTML = `<div id="homepage-games-title" class="homepage-title">
  ...
  <div id="games"></div>`;
    ...
    showView("#homepage");
    let gameList = Object.keys((0, _gamesJsonDefault.default));
    // ['dual-cat', 'rusher-crusher', 'click-for-life']
    for(let i = 0; i < gameList.length; i++){
        let gameObj = (0, _gamesJsonDefault.default)[gameList[i]];
        ...
        console.log((0, _pngDefault.default));
        gameImage.src = (0, _pngDefault.default)[gameList[i]].logo;
...
function loadGames() {
    if (document.location.pathname !== "/homepage") loadHomepage();
...
function loadGame(gameId) {
    ...
    let gameInfo = (0, _gamesJsonDefault.default)[gameId];
    ...
    for(let i = 0, arr = [
        ...
        if (!gameInfo.links[arr[i]]) continue;
        ...
        if (i === 0) {
            linkImage.height = "50";
            linkImage.src = (0, _pngDefault2.default).poki;
            linkImage.alt = "Play on Poki";
            linkImage.title = "Play on Poki";
        } else if (i === 1) {
            linkImage.height = "50";
            linkImage.src = (0, _pngDefault2.default).google;
    ...
    if (gameInfo.links["youtube"]) {
        ...
        youtubeImage.src = (0, _pngDefault.default)[gameId]["youtube_thumbnail"];
    ...
    document.querySelector("#game-view").append(title, description, links, screenshots);
    document.querySelectorAll(".screenshots").forEach((el)=>el.addEventListener("click", (0, _bs5LightboxDefault.default).initialize));
}

},{"bs5-lightbox":"ilnWR","bootstrap":"hjCRY","./content/games.json":"cRR1Y","url:./content/*/*.png":"4juH8","url:./content/*.png":"3B9Ew","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:./content/*/screenshots/*.png":"7w8QU","url:./content/*/screenshots/*.jpg":"jT7eY"}],"ilnWR":[function(require,module,exports,__globalThis) {
/**
...
const bootstrap = {
    ...
    Carousel: (0, _bootstrap.Carousel)
};
class Lightbox {
    constructor(el, options = {}){
        ...
        if (el.dataset.size) this.settings.size = el.dataset.size;
    ...
    getSrc(el) {
        ...
        if (!/\:\/\//.test(src)) src = window.location.origin + src;
        const url = new URL(src);
        if (el.dataset.footer || el.dataset.caption) url.searchParams.set('caption', el.dataset.footer || el.dataset.caption);
        return url.toString();
    }
    getGalleryItems() {
        let galleryTarget;
        ...
        } else if (this.el.dataset.gallery) galleryTarget = this.el.dataset.gallery;
    ...
    createCarousel() {
        ...
        const slidesHtml = this.sources.map((src, i)=>{
            ...
            if (regex.test(src)) src = src.replace(regex, '');
        ...
        if (this.settings.size === 'fullscreen') classes += ' position-absolute w-100 translate-middle top-50 start-50';
        const html = `
        ...
        if (this.carouselOptions.keyboard === true) document.addEventListener('keydown', (e)=>{
            if (e.code === 'ArrowLeft') {
    ...
    findGalleryItemIndex(haystack, needle) {
        ...
        for (const item of haystack){
            if (item.includes(needle)) return index;
            index++;
        }
        return 0;
    }
...
if (typeof window !== 'undefined' && window.bootstrap) window.bootstrap.Lightbox = Lightbox;
exports.default = Lightbox;

},{"bootstrap":"hjCRY","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hjCRY":[function(require,module,exports,__globalThis) {
/*!
...
module.exports = {
    ...
    "click-for-life": {
        "logo": _temp1,
        "youtube_thumbnail": _temp2
    },
    "dual-cat": {
        "dual-cat-carousel": _temp3,
        "logo": _temp4,
        "youtube_thumbnail": _temp5
    },
    "dual-cat-max": {
        "dual-cat--max-carousel": _temp6,
        "logo": _temp7,
    ...
    "hexellent": {
        "hexellent-carousel": _temp11,
        "logo": _temp12
    },
    "misland": {
        "logo": _temp13,
        "youtube_thumbnail": _temp14
    },
    "rusher-crusher": {
        "logo": _temp15,
        "youtube_thumbnail": _temp16
    }
};

},{"645597d07f7604b6":"hiptr","45c2496c54f641ac":"jKOpu","fcf2610486c2984":"fcmWb","d5ccc7b854786b49":"eDkcg","21a0017735c504e":"fENrc","e14a2e8441272bc3":"dED9M","a0ead08e739cf7c3":"iVqNo","6cd0c410188e4723":"56qaL","7d262e921743e6bd":"iUY59","fda222c3475ac948":"ipeYG","a58b01b341d1c741":"2yFyd","3aa33eba8a3a0e92":"dX3aU","5da78e329bdaa0a2":"f24DW","3ecde12f6341b16c":"leMCZ","8d850cfe1cef48ce":"a6ZGs","385dc8ea05acc7b5":"l3lq1","6db28a52d6567cc3":"iqaU3"}],"hiptr":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.be910bab.png") + "?" + Date.now();

},{}],"jKOpu":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.98bd4a7c.png") + "?" + Date.now();

},{}],"fcmWb":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("youtube_thumbnail.859f9d7b.png") + "?" + Date.now();

},{}],"eDkcg":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("dual-cat-carousel.3e0cfa04.png") + "?" + Date.now();

},{}],"fENrc":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.c468468a.png") + "?" + Date.now();

},{}],"dED9M":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("youtube_thumbnail.da0cd0f5.png") + "?" + Date.now();

},{}],"iVqNo":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("dual-cat--max-carousel.f5f0a766.png") + "?" + Date.now();

},{}],"56qaL":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.8bb9dcd1.png") + "?" + Date.now();

},{}],"iUY59":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("youtube_thumbnail.f9a00318.png") + "?" + Date.now();

},{}],"ipeYG":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.094d4a5a.png") + "?" + Date.now();

},{}],"2yFyd":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("youtube_thumbnail.c202d837.png") + "?" + Date.now();

},{}],"dX3aU":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("hexellent-carousel.17cd92c9.png") + "?" + Date.now();

},{}],"f24DW":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.459f8c24.png") + "?" + Date.now();

},{}],"leMCZ":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.b2fdcd3c.png") + "?" + Date.now();

},{}],"a6ZGs":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("youtube_thumbnail.6d1d67c9.png") + "?" + Date.now();

},{}],"l3lq1":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.1951ffd7.png") + "?" + Date.now();

},{}],"iqaU3":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("youtube_thumbnail.ec893fa4.png") + "?" + Date.now();

},{}],"3B9Ew":[function(require,module,exports,__globalThis) {
const _temp0 = require("9e3a230efbf0d98a");
const _temp1 = require("f7171eedd63b9872");
const _temp2 = require("ed13a11200b20c05");
const _temp3 = require("a5a3e80313d1cf72");
const _temp4 = require("fac20b52216019c3");
module.exports = {
    "alpaca": _temp0,
    "favicon": _temp1,
    "google": _temp2,
...
},{"9e3a230efbf0d98a":"9dJqa","f7171eedd63b9872":"8TXdx","ed13a11200b20c05":"bC0GL","a5a3e80313d1cf72":"eTFQt","fac20b52216019c3":"9Bm4F"}],"9dJqa":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("alpaca.51397a37.png") + "?" + Date.now();

},{}],"8TXdx":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("favicon.d0b39b73.png") + "?" + Date.now();

},{}],"bC0GL":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("google.0a1e529b.png") + "?" + Date.now();

},{}],"eTFQt":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("logo.53f716de.png") + "?" + Date.now();

},{}],"9Bm4F":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("poki.3e393dbf.png") + "?" + Date.now();

},{}],"7w8QU":[function(require,module,exports,__globalThis) {
const _temp0 = require("5fa8c3a961349d1c");
const _temp1 = require("a91daab0426f8bb4");
const _temp2 = require("6de38eff8c63de48");
const _temp3 = require("9944f8f6154b89a8");
const _temp4 = require("3f79a06d4e560d02");
const _temp5 = require("729aef1c29c51bee");
const _temp6 = require("5a61466c24c29219");
const _temp7 = require("d98d304b5da48693");
const _temp8 = require("3b36e43d35ccec1a");
const _temp9 = require("5f308b811ae35dee");
const _temp10 = require("dd12bce893667c68");
const _temp11 = require("5a19ad0cdc9e2d67");
const _temp12 = require("290c28a6cc94a481");
const _temp13 = require("994f968de7171298");
const _temp14 = require("5b2c95d670dc7364");
const _temp15 = require("3855e21e5d3e7bdb");
const _temp16 = require("1f90afba1ef454fd");
const _temp17 = require("62266c5be1ad2227");
const _temp18 = require("be7812ce42ce8542");
const _temp19 = require("85a27971aa52bb8a");
const _temp20 = require("42f12279e3b72fbe");
const _temp21 = require("edeec93a0c1843d9");
const _temp22 = require("4b24306e9a91b5db");
const _temp23 = require("2a0bd01d24316dfd");
const _temp24 = require("7827deb0ed124904");
const _temp25 = require("c83b2e6df03b8594");
const _temp26 = require("336b05150ec205e9");
const _temp27 = require("e27d7b0200411cf4");
const _temp28 = require("450d378d2515ccf6");
const _temp29 = require("b66de97d4b91fa7e");
const _temp30 = require("c72e0b040d90c32c");
module.exports = {
    "click-for-life": {
        "Screenshot": _temp0
    },
...
},{"5fa8c3a961349d1c":"5Wjap","a91daab0426f8bb4":"3wZql","6de38eff8c63de48":"aRUf6","9944f8f6154b89a8":"h9yXZ","3f79a06d4e560d02":"4ik6Q","729aef1c29c51bee":"lsZRB","5a61466c24c29219":"h13DW","d98d304b5da48693":"4NGYO","3b36e43d35ccec1a":"3KuXQ","5f308b811ae35dee":"iIc3U","dd12bce893667c68":"30NPx","5a19ad0cdc9e2d67":"8LNUB","290c28a6cc94a481":"6sjBe","994f968de7171298":"5e0vO","5b2c95d670dc7364":"dKDmp","3855e21e5d3e7bdb":"hntub","1f90afba1ef454fd":"9k0pl","62266c5be1ad2227":"5qpgZ","be7812ce42ce8542":"3mEia","85a27971aa52bb8a":"cASIH","42f12279e3b72fbe":"4ujOy","edeec93a0c1843d9":"hXU6b","4b24306e9a91b5db":"lNeFC","2a0bd01d24316dfd":"7ivGr","7827deb0ed124904":"b13zF","c83b2e6df03b8594":"fkGiU","336b05150ec205e9":"d1yXq","e27d7b0200411cf4":"j2vlj","450d378d2515ccf6":"4B8PP","b66de97d4b91fa7e":"kVgID","c72e0b040d90c32c":"4XDPs"}],"5Wjap":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("Screenshot.86d3296b.png") + "?" + Date.now();

},{}],"3wZql":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("e_SS1.a1016bd4.png") + "?" + Date.now();

},{}],"aRUf6":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("e_SS2.28b1f794.png") + "?" + Date.now();

},{}],"h9yXZ":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("e_SS3.75a80f75.png") + "?" + Date.now();

},{}],"4ik6Q":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("e_SS4.0e599d25.png") + "?" + Date.now();

},{}],"lsZRB":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("e_SS5.c897be0b.png") + "?" + Date.now();

},{}],"h13DW":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("e_SS1.7c20628c.png") + "?" + Date.now();

},{}],"4NGYO":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("e_SS3.c9c7360e.png") + "?" + Date.now();

},{}],"3KuXQ":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("e_SS7.b4449225.png") + "?" + Date.now();

},{}],"iIc3U":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("tab1.8d58f900.png") + "?" + Date.now();

},{}],"30NPx":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("tab2.1fd6d3b3.png") + "?" + Date.now();

},{}],"8LNUB":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("tab3.dd49e15c.png") + "?" + Date.now();

},{}],"6sjBe":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("tab4.27c281e8.png") + "?" + Date.now();

},{}],"5e0vO":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("tab5.9796563d.png") + "?" + Date.now();

},{}],"dKDmp":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("tab6.456c9719.png") + "?" + Date.now();

},{}],"hntub":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("tab7.cec9b1e1.png") + "?" + Date.now();

},{}],"9k0pl":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("screenshots_hexellent_1.697b48d8.png") + "?" + Date.now();

},{}],"5qpgZ":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("screenshots_hexellent_2.f60ee882.png") + "?" + Date.now();

},{}],"3mEia":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("screenshots_hexellent_3.871cd5b6.png") + "?" + Date.now();

},{}],"cASIH":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("screenshots_hexellent_4.8af88222.png") + "?" + Date.now();

},{}],"4ujOy":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("screenshots_hexellent_5.f2e14c17.png") + "?" + Date.now();

},{}],"hXU6b":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("screenshots_hexellent_6.eedfb4e2.png") + "?" + Date.now();

},{}],"lNeFC":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("1.82cb1684.png") + "?" + Date.now();

},{}],"7ivGr":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("2.2f530234.png") + "?" + Date.now();

},{}],"b13zF":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("3.86064b81.png") + "?" + Date.now();

},{}],"fkGiU":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("4.762ba548.png") + "?" + Date.now();

},{}],"d1yXq":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("5.abf4c0c9.png") + "?" + Date.now();

},{}],"j2vlj":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("6.4239f9b7.png") + "?" + Date.now();

},{}],"4B8PP":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("SS_donut.2c6e3e96.png") + "?" + Date.now();

},{}],"kVgID":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("SS_menu.54932482.png") + "?" + Date.now();

},{}],"4XDPs":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("SS_tomato.3847f299.png") + "?" + Date.now();

},{}],"jT7eY":[function(require,module,exports,__globalThis) {
const _temp0 = require("15d3dc2cfd23bdfc");
const _temp1 = require("70398940ca38a4b7");
const _temp2 = require("b39e21a466eb5faa");
const _temp3 = require("d11a514476f6ff6d");
const _temp4 = require("731e233bef3e9e32");
const _temp5 = require("3959a08d0ecc3a36");
const _temp6 = require("ec231d0d5ae080f9");
module.exports = {
    "click-for-life": {
        "VmLjL5": _temp0
    },
...
},{"15d3dc2cfd23bdfc":"ayxO0","70398940ca38a4b7":"kKv8N","b39e21a466eb5faa":"k8JbB","d11a514476f6ff6d":"dhA3V","731e233bef3e9e32":"aB0e3","3959a08d0ecc3a36":"bbTPw","ec231d0d5ae080f9":"g11Cm"}],"ayxO0":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("VmLjL5.76c48ab8.jpg") + "?" + Date.now();

},{}],"kKv8N":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("1.44d0d2b7.jpg") + "?" + Date.now();

},{}],"k8JbB":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("2.9d4f20ca.jpg") + "?" + Date.now();

},{}],"dhA3V":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("3.f1d9581e.jpg") + "?" + Date.now();

},{}],"aB0e3":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("4.4e408970.jpg") + "?" + Date.now();

},{}],"bbTPw":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("5.ec64ed61.jpg") + "?" + Date.now();

},{}],"g11Cm":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("6.e21b4e51.jpg") + "?" + Date.now();

},{}]},["kxwl6","jOXmm"], "jOXmm", "parcelRequire8f85", {}, "./", "/")

//# sourceMappingURL=source.e02fbd41.js.map
