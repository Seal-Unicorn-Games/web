...
console.log((0, _gamesJsonDefault.default));
...
function loadGame(gameId) {
    ...
    for(let shot in (0, _pngDefault1.default)[gameId]){
        let screenshotsAnchor = document.createElement("a");
        screenshotsAnchor.href = `${(0, _pngDefault1.default)[gameId][shot]}`;
        ...
        screenshotsImage.src = `${(0, _pngDefault1.default)[gameId][shot]}`;
...
},{}],"204aw":[function(require,module,exports) {
module.exports = require("bcd3a7971c8bd465").getBundleURL("UckoE") + "youtube_thumbnail.2c414f8b.png" + "?" + Date.now();

},{"bcd3a7971c8bd465":"lgJ39"}],"1F1Lf":[function(require,module,exports) {
module.exports = require("ddac5def0e0963b7").getBundleURL("UckoE") + "dual-cat-carousel.7f71298b.png" + "?" + Date.now();

},{"ddac5def0e0963b7":"lgJ39"}],"3JvyS":[function(require,module,exports) {
module.exports = require("85f06058d5adda53").getBundleURL("UckoE") + "logo.ed571763.png" + "?" + Date.now();
...
module.exports = require("2031a37b4a474109").getBundleURL("UckoE") + "youtube_thumbnail.2d4e394a.png" + "?" + Date.now();

},{"2031a37b4a474109":"lgJ39"}],"j8iFe":[function(require,module,exports) {
module.exports = require("73c6eae9a6cfb7ba").getBundleURL("UckoE") + "logo.34f4dc27.png" + "?" + Date.now();
...
module.exports = require("c2dbb14ff362f9bf").getBundleURL("UckoE") + "e_SS3.f4d221f3.png" + "?" + Date.now();
...
module.exports = require("693d4baf832e0ab0").getBundleURL("UckoE") + "tab2.44c10fa8.png" + "?" + Date.now();

},{"693d4baf832e0ab0":"lgJ39"}],"1Cfv4":[function(require,module,exports) {
module.exports = require("cdb5ae9db570329f").getBundleURL("UckoE") + "tab3.e2fa28fa.png" + "?" + Date.now();

},{"cdb5ae9db570329f":"lgJ39"}],"hKcI6":[function(require,module,exports) {
module.exports = require("764a9b8974758de7").getBundleURL("UckoE") + "tab4.127b8e52.png" + "?" + Date.now();

},{"764a9b8974758de7":"lgJ39"}],"axsBK":[function(require,module,exports) {
module.exports = require("42775abebc34b7b2").getBundleURL("UckoE") + "tab5.51aad007.png" + "?" + Date.now();

},{"42775abebc34b7b2":"lgJ39"}],"fNJnE":[function(require,module,exports) {
module.exports = require("df3468c38c323c5f").getBundleURL("UckoE") + "tab6.10249432.png" + "?" + Date.now();
...
module.exports = require("3f75fc312e8099a7").getBundleURL("UckoE") + "SS_menu.22a3c4d0.png" + "?" + Date.now();

},{"3f75fc312e8099a7":"lgJ39"}],"eLiX0":[function(require,module,exports) {
module.exports = require("8d6c17ad51d053d1").getBundleURL("UckoE") + "SS_tomato.c9d94cd0.png" + "?" + Date.now();

},{"8d6c17ad51d053d1":"lgJ39"}],"1hYVV":[function(require,module,exports) {
const _temp0 = require("fbc8d50b32b23367");
const _temp1 = require("db177b0c7f54e73d");
const _temp2 = require("f7102d3d75a63a4d");
const _temp3 = require("cd4c48d5fdff4178");
const _temp4 = require("cf58cebcd9dd26db");
module.exports = {
    "alpaca": _temp0,
    "favicon": _temp1,
    "google": _temp2,
...
},{"fbc8d50b32b23367":"3x4i0","db177b0c7f54e73d":"8raRP","f7102d3d75a63a4d":"kop2N","cd4c48d5fdff4178":"9Lgn8","cf58cebcd9dd26db":"4xSCB"}],"3x4i0":[function(require,module,exports) {
module.exports = require("cf6606aff9e4e5a6").getBundleURL("UckoE") + "alpaca.5deb24f5.png" + "?" + Date.now();

},{"cf6606aff9e4e5a6":"lgJ39"}],"8raRP":[function(require,module,exports) {
module.exports = require("51ddeedfdbc8ef3b").getBundleURL("UckoE") + "favicon.e3cda8cf.png" + "?" + Date.now();

},{"51ddeedfdbc8ef3b":"lgJ39"}],"kop2N":[function(require,module,exports) {
module.exports = require("c7de05dc411ea3b8").getBundleURL("UckoE") + "google.b39c3ec1.png" + "?" + Date.now();

},{"c7de05dc411ea3b8":"lgJ39"}],"9Lgn8":[function(require,module,exports) {
module.exports = require("6f154c19e2cf527").getBundleURL("UckoE") + "logo.0c50caa7.png" + "?" + Date.now();

},{"6f154c19e2cf527":"lgJ39"}],"4xSCB":[function(require,module,exports) {
module.exports = require("95e2eeb1bb75d555").getBundleURL("UckoE") + "poki.5465cd5f.png" + "?" + Date.now();

},{"95e2eeb1bb75d555":"lgJ39"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire8f85")
